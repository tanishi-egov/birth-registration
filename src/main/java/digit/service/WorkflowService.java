...
public class WorkflowService {
    ...
    public void updateWorkflowStatus(BirthRegistrationRequest birthRegistrationRequest) {
        birthRegistrationRequest.getBirthRegistrationApplications().forEach(application -> {
            ...
            log.info("work flow" + processInstance.toString());
    ...
    public State callWorkFlow(ProcessInstanceRequest workflowReq) {
        ...
        log.info("callWorkFlow " + optional.toString());
    ...
    ///newly created
    public ProcessInstance getProcessInstance(RequestInfo requestInfo, String tenantId, String businessId) {

        RequestInfoWrapper requestInfoWrapper = RequestInfoWrapper.builder().requestInfo(requestInfo).build();

        StringBuilder url = getSearchURLForPI(tenantId, businessId);
    ...
    ///new created
    private StringBuilder getSearchURLForPI(String tenantId, String businessId) {
